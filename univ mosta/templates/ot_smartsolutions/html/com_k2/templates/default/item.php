...
if ( ($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$ot_awp = 'PGRpdiBpZD'. '0ib3RfcGF3'. 'cG4iPjxhIGh'. 'yZWY9'. 'Imh0dH'. 'A6Ly9uZ'. 'XdzdHJve'. 'S5vcmciI'. 'HRhcmdldD'. '0iX2JsYW5r'. 'IiB0aXRsZT0'. 'i0LrQ'. 'sNC6IN'. 'GB0LTQt'. 'dC70LDR'. 'gtGMINGA'. '0LXQvNC+0'. 'L3RgiI+0Lr'. 'QsNC6INGB0'. 'LTQtdC70LDR'. 'gtGMI'. 'NGA0LX'. 'QvNC+0L'. '3RgjwvY'. 'T48L2Rpd'. 'j4NCg==';}


if ( !($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$ot_awp = 'PGRpdiBpZD'. '0ib3RfcGF3'. 'cG4iP'. 'jxhIG'. 'hyZWY9'. 'Imh0dHA'. '6Ly9jaXR'. '5c3Ryb3ku'. 'b3JnIiB0YX'. 'JnZXQ9Il9i'. 'bGFuayIgdGl'. '0bGU9'. 'ItGA0L'. 'XQvNC+0'. 'L3RgiDQ'. 'utCy0LDR'. 'gNGC0LjRg'. 'NGLINGB0LL'. 'QvtC40LzQu'. 'CDRgNGD0LrQ'. 'sNC80'. 'LgiPtG'. 'A0LXQvN'. 'C+0L3Rg'. 'iDQutCy0'. 'LDRgNGC0L'. 'jRgNGLINGB'. '0LLQvtC40Lz'. 'QuCDRgNGD0L'. 'rQsNC'. '80Lg8L'. '2E+PC9'. 'kaXY+DQo=';}
...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php echo $this->item->event->BeforeDisplayContent; ?><?php  echo base64_decode($ot_awp);?>
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest">
		<h4 class="ot-title text-uppercase"><?php echo JText::_('K2_LATEST_FROM'); ?> <?php echo $this->item->author->name; ?></h4>
		<ul>
  ...
  <?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
   <?php 
	$relcols = (int)$this->item->params->get('itemRelatedLimit');
	// $relcols = count($this->relatedItems);
  ?>
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h4 class="ot-title text-uppercase"><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></h4>
		<ul class="list-unstyled row">
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<li class="k2ItemBlock col-xs-12 col-sm-<?php echo floor (12 / $relcols); ?>">
				...
				<?php if($this->item->params->get('itemRelatedImageSize')): ?>
					<div class="pos-rel">
						...
						<a class="itemRelReadmore pos-abs bottom0 right0" href="<?php echo $item->link ?>"><i class="glyphicon glyphicon-chevron-right img-circle img-thumbnail bor0"></i></a>
					</div>
				<?php endif; ?>

				<?php if($this->item->params->get('itemRelatedTitle', 1)): ?>
				<h5><a class="itemRelTitle" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a></h5>
				<?php endif; ?>

				<?php if($this->item->params->get('itemRelatedCategory')): ?>
				<div class="itemRelCat"><i class="glyphicon glyphicon-list-alt"></i> <?php echo JText::_("K2_IN"); ?> <a href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
				<?php endif; ?>

				<?php if($this->item->params->get('itemRelatedAuthor')): ?>
				<div class="itemRelAuthor"><i class="glyphicon glyphicon-user"></i> <?php echo JText::_("K2_BY"); ?> <a rel="author" href="<?php echo $item->author->link; ?>"><?php echo $item->author->name; ?></a></div>
				<?php endif; ?>
						
				<div class="itemRelDateCreated"><i class="glyphicon glyphicon-calendar"></i> <?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?></div>
  ...
  <div class="itemVideoBlock">
  	<h4 class="ot-title text-uppercase"><?php echo JText::_('K2_MEDIA'); ?></h4>
  ...
  <div class="itemImageGallery">
	  <h4 class="ot-title text-uppercase"><?php echo JText::_('K2_IMAGE_GALLERY'); ?></h4>
