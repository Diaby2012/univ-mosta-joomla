...
abstract class JHtmlBootstrap
{
	...
	public static function framework($debug = null)
	{
		...
		JHtml::_('script', JURI::root(true) . '/plugins/system/jarvis/assets/3rd/bootstrap/js/bootstrap.min.js', false, true, false, false, $debug);
	...
	public static function renderModal($selector = 'modal', $params = array(), $footer = '')
	{
		...
		$html = "<div class=\"modal fade\" id=\"" . $selector . "\">\n";
		...
		$html .= "document.getElementById('" . $selector . "-container').innerHTML = '<iframe class=\"iframe\" src=\""
			. $params['url'] . "\" height=\"" . $params['height'] . "\" width=\"" . $params['width'] . "\"></iframe>" . $footer . "';\n";
		$html .= "});\n";
		$html .= "</script>";
	...
	public static function addSlide($selector, $text, $id, $class = '')
	{
		...
		$html = '<div class="panel panel-default' . $class . '">'
			...
			. '<h4 class="panel-title"><a href="#' . $id . '" data-parent="#' . $selector . '" data-toggle="collapse" class="accordion-toggle">'
			. $text
			. '</a></h4>'
			. '</div>'
